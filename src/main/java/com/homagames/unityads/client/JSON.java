...
import com.homagames.unityads.client.model.AdvertiseRoasTypes;
import com.homagames.unityads.client.model.AnAdvertiseCampaign;
import com.homagames.unityads.client.toRefactor.*;
...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          .registerTypeSelector(AdvertiseRoasTypes.class, new TypeSelector<AdvertiseRoasTypes>() {
            @Override
            public Class<? extends AdvertiseRoasTypes> getClassForElement(JsonElement readElement) {
                Map<String, Class<? extends AdvertiseRoasTypes>> classByDiscriminatorValue = new HashMap<>();
                    classByDiscriminatorValue.put("advertise.nonEmptyRoasTypes".toUpperCase(), AdvertiseNonEmptyRoasTypes.class);
                    classByDiscriminatorValue.put("AdvertiseRoasTypes".toUpperCase(), AdvertiseRoasTypes.class);
                return getClassByDiscriminator(
                            classByDiscriminatorValue,
                            getDiscriminatorValue(readElement, ""));
            }
          })
          .registerPostProcessor(AdvertiseRoasTypes.class, new PostProcessor<AdvertiseRoasTypes>() {
              @Override
              public void postDeserialize(AdvertiseRoasTypes result, JsonElement src, Gson gson) {

              }

              @Override
              public void postSerialize(JsonElement result, AdvertiseRoasTypes src, Gson gson) {
                  Map<Class<? extends AdvertiseRoasTypes>, String> discriminatorValueByClass = new HashMap<>();
                      discriminatorValueByClass.put(AdvertiseNonEmptyRoasTypes.class, "advertise.nonEmptyRoasTypes");
                      discriminatorValueByClass.put(AdvertiseRoasTypes.class, "AdvertiseRoasTypes");
