 ...
 */
@JsonAdapter(AdvertiseCountry.Adapter.class)
public enum AdvertiseCountry {
  AD("AD"),
  AE("AE"),
  AF("AF"),
  AG("AG"),
  ...
  public static AdvertiseCountry fromValue(String input) {
    for (AdvertiseCountry b : AdvertiseCountry.values()) {
  ...
  public static class Adapter extends TypeAdapter<AdvertiseCountry> {
    @Override
    public void write(final JsonWriter jsonWriter, final AdvertiseCountry enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public AdvertiseCountry read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return AdvertiseCountry.fromValue((String)(value));
    }
  }
}
