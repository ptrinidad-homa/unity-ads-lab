...
import com.homagames.unityads.client.toRefactor.AdvertiseCreative;
import com.homagames.unityads.client.toRefactor.AdvertiseCreativesResponseBody;
...
public class CreativesApi {
    ...
    public CreativesApi(String apiKey) {
    ...
    /**
     * Build call for advertiseCreateCreative
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call advertiseCreateCreativeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/advertise/v1/organizations/{organizationId}/apps/{campaignSetId}/creatives";
    ...
    private com.squareup.okhttp.Call advertiseCreateCreativeValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = advertiseCreateCreativeCall(progressListener, progressRequestListener);
        return call;
     ...
     */
    public AdvertiseCreative advertiseCreateCreative() throws ApiException {
        ApiResponse<AdvertiseCreative> resp = advertiseCreateCreativeWithHttpInfo();
        return resp.getData();
    }
     ...
     * Create Creative
     * Upload an end card or video creative using this endpoint.  Three different types of creatives can currently be created through this API:  * **Square end card**:  a single square shaped 800 × 800 image. * **End card pair**:  a 600 × 800 portrait image and a 800 × 600 landscape image. * **Video**:  contains either a 9:16 portrait video or a 16:9 landscape video. * **Playable**: contains an MRAID 2.0 compliant HTML document in a portrait, landscape or responsive orientation. [See full playable guidelines](https://unityads.unity3d.com/help/advertising/campaign-design-guide#playables).  Each creative type requires a slightly different JSON payload and a different set of binary files:  * one image file for a square end card, * two image files for an end card pair, * one video file for a video creative. * one HTML file for a playable creative.  To create a creative, you will need to send a HTTP request with content type of &#x60;multipart/form-data&#x60; to the API endpoint. The first part of the multipart form should contain a field named &#x60;creativeInfo&#x60; that contains JSON metadata about the creative, followed by one or more additional parts containing the binary data for each creative file.  **Example**  For a square end card the raw HTTP request could look for example following: &#x60;&#x60;&#x60; POST /advertise/v1/organizations/&lt;ORGANIZATION_ID&gt;/apps/&lt;CAMPAIGN_SET_ID&gt;/creatives HTTP/1.1 Host: services.api.unity.com:443 Authorization: Basic &lt;SERVICE_ACCOUNT_CREDENTIALS&gt; Content-Type: multipart/form-data; boundary&#x3D;--------------------------371131627955007232942795 Content-Length: 51165 ----------------------------371131627955007232942795 Content-Disposition: form-data; name&#x3D;\&quot;creativeInfo\&quot; Content-Type: application/json  {   \&quot;name\&quot;: \&quot;My Creative\&quot;,   \&quot;language\&quot;: \&quot;en\&quot;,   \&quot;squareEndCard\&quot;: {     \&quot;fileName\&quot;: \&quot;myCreative.jpeg\&quot;   } } ----------------------------371131627955007232942795 Content-Disposition: form-data; name&#x3D;\&quot;squareEndCardFile\&quot;; filename&#x3D;\&quot;myCreative.jpeg\&quot;  &lt;IMAGE_BINARY_DATA&gt; ----------------------------371131627955007232942795-- &#x60;&#x60;&#x60;  Notice that the place holders &#x60;&lt;ORGANIZATION_ID&gt;&#x60;, &#x60;&lt;CAMPAIGN_SET_ID&gt;&#x60;, &#x60;&lt;SERVICE_ACCOUNT_CREDENTIALS&gt;&#x60; and &#x60;&lt;IMAGE_BINARY_DATA&gt;&#x60; need to be replaced with valid values.  When uploading creative assets, please observe Unity’s advertising content policy. [Read more](https://unity3d.com/legal/advertising-content-policy)  A continuous data flow is expected when uploading the file. The creative upload is allowed to take at most 5 minutes. This means that if you are creating a creative that contains a video that has the maximum file size of 100 MB then your average upload speed must at least 2.7 Mbps. If the upload takes longer than 5 minutes then the request will fail.  If the upload halts (no bytes are transferred) for over 30 seconds then the request will fail.  If the same files have already been uploaded as part of a previous creative, the existing creative is returned and no new one is created. 
     * @return ApiResponse&lt;AdvertiseCreative&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AdvertiseCreative> advertiseCreateCreativeWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = advertiseCreateCreativeValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<AdvertiseCreative>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call advertiseCreateCreativeAsync(final ApiCallback<AdvertiseCreative> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseCreateCreativeValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AdvertiseCreative>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for advertiseGetCreative
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call advertiseGetCreativeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/advertise/v1/organizations/{organizationId}/apps/{campaignSetId}/creatives/{creativeId}";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call advertiseGetCreativeValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = advertiseGetCreativeCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AdvertiseCreative advertiseGetCreative() throws ApiException {
        ApiResponse<AdvertiseCreative> resp = advertiseGetCreativeWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AdvertiseCreative> advertiseGetCreativeWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = advertiseGetCreativeValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<AdvertiseCreative>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call advertiseGetCreativeAsync(final ApiCallback<AdvertiseCreative> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseGetCreativeValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AdvertiseCreative>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for advertiseListCreatives
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call advertiseListCreativesCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call advertiseListCreativesValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = advertiseListCreativesCall(progressListener, progressRequestListener);
        return call;
     ...
     * @return AdvertiseCreativesResponseBody
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AdvertiseCreativesResponseBody advertiseListCreatives() throws ApiException {
        ApiResponse<AdvertiseCreativesResponseBody> resp = advertiseListCreativesWithHttpInfo();
        return resp.getData();
    }
     ...
     * List Creatives
     * This endpoint returns all available creatives that are under the given app. 
     * @return ApiResponse&lt;AdvertiseCreativesResponseBody&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AdvertiseCreativesResponseBody> advertiseListCreativesWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = advertiseListCreativesValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<AdvertiseCreativesResponseBody>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * List Creatives (asynchronously)
     * This endpoint returns all available creatives that are under the given app. 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call advertiseListCreativesAsync(final ApiCallback<AdvertiseCreativesResponseBody> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseListCreativesValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AdvertiseCreativesResponseBody>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
