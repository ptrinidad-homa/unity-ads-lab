...
import com.homagames.unityads.client.toRefactor.AdvertiseCreateCreativePackRequestBody;
import com.homagames.unityads.client.toRefactor.AdvertiseCreativePack;
import com.homagames.unityads.client.toRefactor.AdvertiseCreativePacksResponseBody;
...
public class CreativePacksApi {
    private ApiClient apiClient;

    public CreativePacksApi(String apiKey) {
    ...
    /**
     * Build call for advertiseCreateCreativePack
     * @param body  (required)
     ...
     */
    public com.squareup.okhttp.Call advertiseCreateCreativePackCall(AdvertiseCreateCreativePackRequestBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/advertise/v1/organizations/{organizationId}/apps/{campaignSetId}/creative-packs";
    ...
    private com.squareup.okhttp.Call advertiseCreateCreativePackValidateBeforeCall(AdvertiseCreateCreativePackRequestBody body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling advertiseCreateCreativePack(Async)");
        }
        
        com.squareup.okhttp.Call call = advertiseCreateCreativePackCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @param body  (required)
     * @return AdvertiseCreativePack
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AdvertiseCreativePack advertiseCreateCreativePack(AdvertiseCreateCreativePackRequestBody body) throws ApiException {
        ApiResponse<AdvertiseCreativePack> resp = advertiseCreateCreativePackWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * Create a creative pack using this endpoint.  Three different types of creative packs can be currently created through this API:  * **video**: this creative pack type contains a single end card creative (square end card or end card pair) and one or two video creatives (one end card + 1-2 videos). * **playable**: this creative pack type contains one or two playable creatives. * **video and playable**: this creative pack type contains one or two video creatives and a single responsive playable.  Each creative pack type requires different &#x60;creativeIds&#x60; which have to match with the given creative pack type. If the creatives referenced by the &#x60;creativeIds&#x60; do not match with the creative pack&#x27;s &#x60;type&#x60; then the API will respond with &#x60;400&#x60; bad request.  Available creatives for your app can be listed via &lt;a href&#x3D;\&quot;#operation/advertise-listCreatives\&quot;&gt;list Creatives&lt;/a&gt; endpoint. 
     * @param body  (required)
     * @return ApiResponse&lt;AdvertiseCreativePack&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AdvertiseCreativePack> advertiseCreateCreativePackWithHttpInfo(AdvertiseCreateCreativePackRequestBody body) throws ApiException {
        com.squareup.okhttp.Call call = advertiseCreateCreativePackValidateBeforeCall(body, null, null);
        Type localVarReturnType = new TypeToken<AdvertiseCreativePack>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create Creative Pack (asynchronously)
     * Create a creative pack using this endpoint.  Three different types of creative packs can be currently created through this API:  * **video**: this creative pack type contains a single end card creative (square end card or end card pair) and one or two video creatives (one end card + 1-2 videos). * **playable**: this creative pack type contains one or two playable creatives. * **video and playable**: this creative pack type contains one or two video creatives and a single responsive playable.  Each creative pack type requires different &#x60;creativeIds&#x60; which have to match with the given creative pack type. If the creatives referenced by the &#x60;creativeIds&#x60; do not match with the creative pack&#x27;s &#x60;type&#x60; then the API will respond with &#x60;400&#x60; bad request.  Available creatives for your app can be listed via &lt;a href&#x3D;\&quot;#operation/advertise-listCreatives\&quot;&gt;list Creatives&lt;/a&gt; endpoint. 
     * @param body  (required)
     ...
     */
    public com.squareup.okhttp.Call advertiseCreateCreativePackAsync(AdvertiseCreateCreativePackRequestBody body, final ApiCallback<AdvertiseCreativePack> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseCreateCreativePackValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AdvertiseCreativePack>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for advertiseDeleteCreativePack
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call advertiseDeleteCreativePackCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/advertise/v1/organizations/{organizationId}/apps/{campaignSetId}/creative-packs/{creativePackId}";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call advertiseDeleteCreativePackValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = advertiseDeleteCreativePackCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void advertiseDeleteCreativePack() throws ApiException {
        advertiseDeleteCreativePackWithHttpInfo();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> advertiseDeleteCreativePackWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = advertiseDeleteCreativePackValidateBeforeCall(null, null);
        return apiClient.execute(call);
    }

    /**
     * Delete Creative Pack (asynchronously)
     * This endpoint removes a creative pack by the creative pack ID and campaign set ID. 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call advertiseDeleteCreativePackAsync(final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseDeleteCreativePackValidateBeforeCall(progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     * Build call for advertiseGetCreativePack
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call advertiseGetCreativePackCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call advertiseGetCreativePackValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = advertiseGetCreativePackCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AdvertiseCreativePack advertiseGetCreativePack() throws ApiException {
        ApiResponse<AdvertiseCreativePack> resp = advertiseGetCreativePackWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AdvertiseCreativePack> advertiseGetCreativePackWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = advertiseGetCreativePackValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<AdvertiseCreativePack>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get Creative Pack (asynchronously)
     * This endpoint returns a creative pack by the creative pack ID and campaign set ID. 
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call advertiseGetCreativePackAsync(final ApiCallback<AdvertiseCreativePack> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseGetCreativePackValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AdvertiseCreativePack>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for advertiseListCreativePacks
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call advertiseListCreativePacksCall(Integer offset, Integer limit, String filterName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call advertiseListCreativePacksValidateBeforeCall(Integer offset, Integer limit, String filterName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = advertiseListCreativePacksCall(offset, limit, filterName, progressListener, progressRequestListener);
        return call;
     ...
     * @param limit Amount of entities to return. (optional)
     * @param filterName  (optional)
     * @return AdvertiseCreativePacksResponseBody
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AdvertiseCreativePacksResponseBody advertiseListCreativePacks(Integer offset, Integer limit, String filterName) throws ApiException {
        ApiResponse<AdvertiseCreativePacksResponseBody> resp = advertiseListCreativePacksWithHttpInfo(offset, limit, filterName);
        return resp.getData();
    }
     ...
     * @param limit Amount of entities to return. (optional)
     * @param filterName  (optional)
     * @return ApiResponse&lt;AdvertiseCreativePacksResponseBody&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AdvertiseCreativePacksResponseBody> advertiseListCreativePacksWithHttpInfo(Integer offset, Integer limit, String filterName) throws ApiException {
        com.squareup.okhttp.Call call = advertiseListCreativePacksValidateBeforeCall(offset, limit, filterName, null, null);
        Type localVarReturnType = new TypeToken<AdvertiseCreativePacksResponseBody>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * List Creative Packs (asynchronously)
     * This endpoint returns creative packs that are under the given app. 
     * @param offset Offset tells to skip that many entities before start returning entities. &#x60;offset&#x3D;0&#x60; is the same as omitting the offset clause. If both &#x60;offset&#x60; and &#x60;limit&#x60; are present, then &#x60;offset&#x60; entities are skipped before starting to count the &#x60;limit&#x60; entities that are returned.  (optional)
     * @param limit Amount of entities to return. (optional)
     * @param filterName  (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call advertiseListCreativePacksAsync(Integer offset, Integer limit, String filterName, final ApiCallback<AdvertiseCreativePacksResponseBody> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseListCreativePacksValidateBeforeCall(offset, limit, filterName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AdvertiseCreativePacksResponseBody>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
