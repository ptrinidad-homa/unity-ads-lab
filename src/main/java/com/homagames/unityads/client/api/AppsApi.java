...
package com.homagames.unityads.client.api;

import com.google.gson.reflect.TypeToken;
import com.homagames.unityads.client.ApiCallback;
import com.homagames.unityads.client.ApiClient;
import com.homagames.unityads.client.ApiException;
import com.homagames.unityads.client.ApiResponse;
import com.homagames.unityads.client.Configuration;
import com.homagames.unityads.client.Pair;
import com.homagames.unityads.client.ProgressRequestBody;
import com.homagames.unityads.client.ProgressResponseBody;
import com.homagames.unityads.client.dto.apps.AdvertiseAppsResponseBody;
import com.homagames.unityads.client.dto.apps.AdvertiseCreateAppRequestBody;
import com.homagames.unityads.client.model.AdvertiseApp;
import com.homagames.unityads.client.toRefactor.AdvertiseUpdateAppRequestBody;
...
public class AppsApi {
    ...
    /**
     * Build call for advertiseCreateApp
     * @param body  (required)
     * @param organizationId Core ID of the organization.  You can look up your Organization&#x27;s ID by opening up the [Acquire Dashboard](https://dashboard.unity3d.com/acquire) and by looking up the ID from the browser&#x27;s address bar: &#x60;https://dashboard.unity3d.com/organizations/&lt;ORGANIZATION_ID_IS_HERE&gt;/acquire/about&#x60;  For further information about the IDs, please see following [documentation](#section/General-Information/Resource-IDs-Used-in-the-API-Calls).  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call advertiseCreateAppCall(AdvertiseCreateAppRequestBody body, Long organizationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/advertise/v1/organizations/{organizationId}/apps"
    ...
    private com.squareup.okhttp.Call advertiseCreateAppValidateBeforeCall(AdvertiseCreateAppRequestBody body, Long organizationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling advertiseCreateApp(Async)");
        }
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling advertiseCreateApp(Async)");
        }
        
        com.squareup.okhttp.Call call = advertiseCreateAppCall(body, organizationId, progressListener, progressRequestListener);
        return call;
    }
     ...
     */
    public AdvertiseApp advertiseCreateApp(AdvertiseCreateAppRequestBody body, Long organizationId) throws ApiException {
        ApiResponse<AdvertiseApp> resp = advertiseCreateAppWithHttpInfo(body, organizationId);
        return resp.getData();
    }
     ...
     * @param body  (required)
     * @param organizationId Core ID of the organization.  You can look up your Organization&#x27;s ID by opening up the [Acquire Dashboard](https://dashboard.unity3d.com/acquire) and by looking up the ID from the browser&#x27;s address bar: &#x60;https://dashboard.unity3d.com/organizations/&lt;ORGANIZATION_ID_IS_HERE&gt;/acquire/about&#x60;  For further information about the IDs, please see following [documentation](#section/General-Information/Resource-IDs-Used-in-the-API-Calls).  (required)
     * @return ApiResponse&lt;AdvertiseApp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AdvertiseApp> advertiseCreateAppWithHttpInfo(AdvertiseCreateAppRequestBody body, Long organizationId) throws ApiException {
        com.squareup.okhttp.Call call = advertiseCreateAppValidateBeforeCall(body, organizationId, null, null);
        Type localVarReturnType = new TypeToken<AdvertiseApp>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call advertiseCreateAppAsync(AdvertiseCreateAppRequestBody body, Long organizationId, final ApiCallback<AdvertiseApp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseCreateAppValidateBeforeCall(body, organizationId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AdvertiseApp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for advertiseDeleteApp
     * @param organizationId Core ID of the organization.  You can look up your Organization&#x27;s ID by opening up the [Acquire Dashboard](https://dashboard.unity3d.com/acquire) and by looking up the ID from the browser&#x27;s address bar: &#x60;https://dashboard.unity3d.com/organizations/&lt;ORGANIZATION_ID_IS_HERE&gt;/acquire/about&#x60;  For further information about the IDs, please see following [documentation](#section/General-Information/Resource-IDs-Used-in-the-API-Calls).  (required)
     * @param campaignSetId Unique identifier for an App. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call advertiseDeleteAppCall(Long organizationId, String campaignSetId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/advertise/v1/organizations/{organizationId}/apps/{campaignSetId}"
            .replaceAll("\\{" + "organizationId" + "\\}", apiClient.escapeString(organizationId.toString()))
    ...
    private com.squareup.okhttp.Call advertiseDeleteAppValidateBeforeCall(Long organizationId, String campaignSetId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling advertiseDeleteApp(Async)");
        }
        // verify the required parameter 'campaignSetId' is set
        if (campaignSetId == null) {
            throw new ApiException("Missing the required parameter 'campaignSetId' when calling advertiseDeleteApp(Async)");
        }
        
        com.squareup.okhttp.Call call = advertiseDeleteAppCall(organizationId, campaignSetId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void advertiseDeleteApp(Long organizationId, String campaignSetId) throws ApiException {
        advertiseDeleteAppWithHttpInfo(organizationId, campaignSetId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> advertiseDeleteAppWithHttpInfo(Long organizationId, String campaignSetId) throws ApiException {
        com.squareup.okhttp.Call call = advertiseDeleteAppValidateBeforeCall(organizationId, campaignSetId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call advertiseDeleteAppAsync(Long organizationId, String campaignSetId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseDeleteAppValidateBeforeCall(organizationId, campaignSetId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     * Build call for advertiseGetApp
     * @param organizationId Core ID of the organization.  You can look up your Organization&#x27;s ID by opening up the [Acquire Dashboard](https://dashboard.unity3d.com/acquire) and by looking up the ID from the browser&#x27;s address bar: &#x60;https://dashboard.unity3d.com/organizations/&lt;ORGANIZATION_ID_IS_HERE&gt;/acquire/about&#x60;  For further information about the IDs, please see following [documentation](#section/General-Information/Resource-IDs-Used-in-the-API-Calls).  (required)
     * @param campaignSetId Unique identifier for an App. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call advertiseGetAppCall(Long organizationId, String campaignSetId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call advertiseGetAppValidateBeforeCall(Long organizationId, String campaignSetId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling advertiseGetApp(Async)");
        }
        // verify the required parameter 'campaignSetId' is set
        if (campaignSetId == null) {
            throw new ApiException("Missing the required parameter 'campaignSetId' when calling advertiseGetApp(Async)");
        }
        
        com.squareup.okhttp.Call call = advertiseGetAppCall(organizationId, campaignSetId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AdvertiseApp advertiseGetApp(Long organizationId, String campaignSetId) throws ApiException {
        ApiResponse<AdvertiseApp> resp = advertiseGetAppWithHttpInfo(organizationId, campaignSetId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AdvertiseApp> advertiseGetAppWithHttpInfo(Long organizationId, String campaignSetId) throws ApiException {
        com.squareup.okhttp.Call call = advertiseGetAppValidateBeforeCall(organizationId, campaignSetId, null, null);
        Type localVarReturnType = new TypeToken<AdvertiseApp>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call advertiseGetAppAsync(Long organizationId, String campaignSetId, final ApiCallback<AdvertiseApp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseGetAppValidateBeforeCall(organizationId, campaignSetId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AdvertiseApp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for advertiseListApps
     * @param organizationId Core ID of the organization.  You can look up your Organization&#x27;s ID by opening up the [Acquire Dashboard](https://dashboard.unity3d.com/acquire) and by looking up the ID from the browser&#x27;s address bar: &#x60;https://dashboard.unity3d.com/organizations/&lt;ORGANIZATION_ID_IS_HERE&gt;/acquire/about&#x60;  For further information about the IDs, please see following [documentation](#section/General-Information/Resource-IDs-Used-in-the-API-Calls).  (required)
     * @param offset Offset tells to skip that many entities before start returning entities. &#x60;offset&#x3D;0&#x60; is the same as omitting the offset clause. If both &#x60;offset&#x60; and &#x60;limit&#x60; are present, then &#x60;offset&#x60; entities are skipped before starting to count the &#x60;limit&#x60; entities that are returned.  (optional)
     * @param limit Amount of entities to return. (optional)
     * @param filterStore  (optional)
     * @param filterStoreId  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call advertiseListAppsCall(Long organizationId, Integer offset, Integer limit, String filterStore, String filterStoreId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (filterStore != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("filter[store]", filterStore));
        if (filterStoreId != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("filter[storeId]", filterStoreId));
    ...
    private com.squareup.okhttp.Call advertiseListAppsValidateBeforeCall(Long organizationId, Integer offset, Integer limit, String filterStore, String filterStoreId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling advertiseListApps(Async)");
        }
        
        com.squareup.okhttp.Call call = advertiseListAppsCall(organizationId, offset, limit, filterStore, filterStoreId, progressListener, progressRequestListener);
        return call;
    }
     ...
     * @param filterStore  (optional)
     * @param filterStoreId  (optional)
     * @return AdvertiseAppsResponseBody
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AdvertiseAppsResponseBody advertiseListApps(Long organizationId, Integer offset, Integer limit, String filterStore, String filterStoreId) throws ApiException {
        ApiResponse<AdvertiseAppsResponseBody> resp = advertiseListAppsWithHttpInfo(organizationId, offset, limit, filterStore, filterStoreId);
        return resp.getData();
    }
     ...
     * @param filterStore  (optional)
     * @param filterStoreId  (optional)
     * @return ApiResponse&lt;AdvertiseAppsResponseBody&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AdvertiseAppsResponseBody> advertiseListAppsWithHttpInfo(Long organizationId, Integer offset, Integer limit, String filterStore, String filterStoreId) throws ApiException {
        com.squareup.okhttp.Call call = advertiseListAppsValidateBeforeCall(organizationId, offset, limit, filterStore, filterStoreId, null, null);
        Type localVarReturnType = new TypeToken<AdvertiseAppsResponseBody>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call advertiseListAppsAsync(Long organizationId, Integer offset, Integer limit, String filterStore, String filterStoreId, final ApiCallback<AdvertiseAppsResponseBody> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseListAppsValidateBeforeCall(organizationId, offset, limit, filterStore, filterStoreId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AdvertiseAppsResponseBody>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for advertiseUpdateApp
     * @param body  (required)
     * @param organizationId Core ID of the organization.  You can look up your Organization&#x27;s ID by opening up the [Acquire Dashboard](https://dashboard.unity3d.com/acquire) and by looking up the ID from the browser&#x27;s address bar: &#x60;https://dashboard.unity3d.com/organizations/&lt;ORGANIZATION_ID_IS_HERE&gt;/acquire/about&#x60;  For further information about the IDs, please see following [documentation](#section/General-Information/Resource-IDs-Used-in-the-API-Calls).  (required)
     * @param campaignSetId Unique identifier for an App. (required)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call advertiseUpdateAppCall(AdvertiseUpdateAppRequestBody body, Long organizationId, String campaignSetId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    private com.squareup.okhttp.Call advertiseUpdateAppValidateBeforeCall(AdvertiseUpdateAppRequestBody body, Long organizationId, String campaignSetId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling advertiseUpdateApp(Async)");
        }
        // verify the required parameter 'organizationId' is set
        if (organizationId == null) {
            throw new ApiException("Missing the required parameter 'organizationId' when calling advertiseUpdateApp(Async)");
        }
        // verify the required parameter 'campaignSetId' is set
        if (campaignSetId == null) {
            throw new ApiException("Missing the required parameter 'campaignSetId' when calling advertiseUpdateApp(Async)");
        }
        
        com.squareup.okhttp.Call call = advertiseUpdateAppCall(body, organizationId, campaignSetId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AdvertiseApp advertiseUpdateApp(AdvertiseUpdateAppRequestBody body, Long organizationId, String campaignSetId) throws ApiException {
        ApiResponse<AdvertiseApp> resp = advertiseUpdateAppWithHttpInfo(body, organizationId, campaignSetId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AdvertiseApp> advertiseUpdateAppWithHttpInfo(AdvertiseUpdateAppRequestBody body, Long organizationId, String campaignSetId) throws ApiException {
        com.squareup.okhttp.Call call = advertiseUpdateAppValidateBeforeCall(body, organizationId, campaignSetId, null, null);
        Type localVarReturnType = new TypeToken<AdvertiseApp>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call advertiseUpdateAppAsync(AdvertiseUpdateAppRequestBody body, Long organizationId, String campaignSetId, final ApiCallback<AdvertiseApp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = advertiseUpdateAppValidateBeforeCall(body, organizationId, campaignSetId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AdvertiseApp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
